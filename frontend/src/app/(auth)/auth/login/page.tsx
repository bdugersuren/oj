...
import { Eye, EyeOff, Trophy, ArrowLeft, Loader2, Lock, Mail } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = error?.response?.data?.detail || error.message || "Нэвтрэх мэдээлэл буруу байна.";
      toast.error(msg);
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black">Нэвтрэх</h1>
            <p className="text-sm text-muted-foreground mt-1.5">OJ Platform-д тавтай морил</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-brand-cyan hover:underline">
                  Мартсан уу?
                </Link>
              </div>
              <div className="relative">
            ...
            >
              {isLoading ? (
                <><Loader2 className="w-4 h-4 mr-2 animate-spin" /> Нэвтэрч байна...</>
              ) : (
                "Нэвтрэх"
              )}
            </Button>
